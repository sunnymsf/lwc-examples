...
import { default as doctype_shared_folder } from './doctype/shared_folder.html';
...
import { default as doctype_zip } from './doctype/zip.html';
            ...
            export default {
                doctype_ai,doctype_attachment,doctype_audio,doctype_box_notes,doctype_csv,doctype_eps,doctype_excel,doctype_exe,doctype_flash,doctype_folder,doctype_gdoc,doctype_gdocs,doctype_gform,doctype_gpres,doctype_gsheet,doctype_html,doctype_image,doctype_keynote,doctype_library_folder,doctype_link,doctype_mp4,doctype_overlay,doctype_pack,doctype_pages,doctype_pdf,doctype_ppt,doctype_psd,doctype_quip_doc,doctype_quip_sheet,doctype_quip_slide,doctype_rtf,doctype_shared_folder,doctype_slide,doctype_stypi,doctype_txt,doctype_unknown,doctype_video,doctype_visio,doctype_webex,doctype_word,doctype_xml,doctype_zip
            };