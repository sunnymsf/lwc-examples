...
/**
 * Blocklisted Entity and Field combinations.
 */
export const BLOCKLIST_ENTITY_FIELDS = {
    Task: ['IsRecurrence', 'IsReminderSet'],
    Event: ['IsRecurrence', 'IsRecurrence2', 'IsReminderSet'],
};
