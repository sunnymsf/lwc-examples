...
import { isCSR, isRTL, keyCodes } from 'lightning/utilsPrivate';
...
export default class LightningTreeItem extends LightningShadowBaseClass {
    ...
    get computedIconName() {
        return isRTL() ? 'utility:chevronleft' : 'utility:chevronright';
    }
    ...
    handleKeydown(event) {
        switch (event.keyCode) {
            ...
            case keyCodes.end:
                this.preventDefaultAndStopPropagation(event);
                // disabled because this function is not renedered on first paint
                /* eslint-disable @lwc/lwc/no-unsupported-ssr-properties, @lwc/lwc/no-restricted-browser-globals-during-ssr */
                this.dispatchEvent(
