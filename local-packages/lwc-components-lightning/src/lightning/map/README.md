...
-   Map component has dependency on core and further details in Implementation section. Also see [Spec](https://gus.lightning.force.com/lightning/r/0D5EE00001TAkLL0A1/view) for technical details.

## Prior Art

-   [SLDS mockups](https://latest-214.lightningdesignsystem.com/components/map/)
    [Map Component Definition](https://gus.lightning.force.com/lightning/r/0D5EE00001TAX4b0AH/view)
