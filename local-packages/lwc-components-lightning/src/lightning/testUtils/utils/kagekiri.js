...
var node = createCommonjsModule(function (module, exports) {
    ...
    var Node =
        ...
        (function () {
            ...
            _proto.appendToPropertyAndEscape =
                function appendToPropertyAndEscape(name, value, valueEscaped) {
                    if (!this.raws) {
                        this.raws = {};
                    }
...
var parser = createCommonjsModule(function (module, exports) {
    ...
    var Parser =
        ...
        (function () {
                        ...
                        case tokens.asterisk:
                            if (next[_tokenize.FIELDS.TYPE] === tokens.equals) {
                                ...
                                if (commentBefore) {
                                    ...
                                    node.raws.spaces.attribute.before =
                                        spaceBefore;
                                    commentBefore = '';
                                }
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (spaceBefore) {
                                        ...
                                        node.spaces.insensitive.before =
                                            spaceBefore;
                                        spaceBefore = '';
                                    }
             ...
             */
            _proto.locateNextMeaningfulToken =
                function locateNextMeaningfulToken(startPosition) {
                    ...
                    while (searchPosition < this.tokens.length) {
                        if (
                            WHITESPACE_EQUIV_TOKENS[
                                this.tokens[searchPosition][
                                    _tokenize.FIELDS.TYPE
                                ]
                            ]
                        ) {
                            searchPosition++;
