...
import labelBadNumericInput from '@salesforce/label/LightningErrorMessage.validityBadNumericInput';
import labelBadEmailInput from '@salesforce/label/LightningErrorMessage.validityBadEmailInput';
...
import { assert, reflectAttribute } from 'lightning/utilsPrivate';
...
const defaultLabels = {
    ...
    badNumericInput: labelBadNumericInput,
    badEmailInput: labelBadEmailInput,
