...
export default class LightningFormattedAddress extends LightningShadowBaseClass {
    ...
    /**
     * Whether the slds-truncate class is assigned to each address line. Accepted variants
     * are truncate and plain. The default variant is truncate.
     * @type {string}
     * @default truncate
     */
    @api
