...
By default, the [slds-truncate](https://www.lightningdesignsystem.com/utilities/truncation/) class is assigned to each line of the address.
To remove address line truncation, set `variant="plain"`. This will render each address line without truncating it.
