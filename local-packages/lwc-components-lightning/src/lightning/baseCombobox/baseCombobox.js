...
export default class LightningBaseCombobox extends LightningShadowBaseClass {
    ...
    renderedCallback() {
        ...
        reflectAttribute(
            ...
            'data-input-pill-close-primicon',
            this.isCloseVisible
        );
        reflectAttribute(
            this.template.querySelector('slds-combobox__input-entity-icon'),
