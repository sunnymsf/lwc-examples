...
const defaultCapabilities = [
    {
        ...
        'goog:chromeOptions': {
            ...
            args: ['--disable-gpu', '--headless', '--window-size=1920,1080', '--no-sandbox', '--disable-dev-shm-usage'],
        },
...
const defaultMochaTimeoutInterval = 200000; //increased timeout because its taking more time to load for references file

// Use chrome specified version at CHROMEDRIVER_VERSION env variable or latests
const chrome =
    (process.env.CHROME_DRIVER_VERSION && { version: process.env.CHROME_DRIVER_VERSION }) || true;
...
exports.config = {
    ...
    //
    // Specs to run the tests
    specs: ['./e2e/specs/**/*.test.ts'],
    //
    ...
    mochaOpts: {
        ...
        ui: 'bdd',
        timeout: debug ? 24 * 60 * 60 * 1000 : defaultMochaTimeoutInterval,
    },
